...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import NOMAD_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("2fc7fd02-576c-576e-a36a-6afce71715da"))
platforms = [Pkg.Artifacts.unpack_platform(e, "NOMAD", artifacts_toml) for e in artifacts["NOMAD"]]
...
if best_platform === nothing
    @debug("Unable to load NOMAD; unsupported platform $(triplet(platform_key_abi()))")
else
